(module 
  ...
  (import "env" "STACKTOP" (global $INITIAL_STACK_TOP i32)) (;5;)
  (import "env" "STACK_MAX" (global $EXPORTED_STACK_MAX i32)) (;6;)
  (import "env" "DYNAMICTOP_PTR" (global $IMPORTED_DYNAMICTOP_PTR i32))(;2;)
  ...
  (func $ret_4420 (type 2) (result i32)
    (local i32 i32)
    get_global $STACK_TOP
    set_local 1
    i32.const 4420
    return)

  (global $STACK_MAX (mut i32) (get_global $EXPORTED_STACK_MAX)) (;13;)
  (global $STACK_TOP (mut i32) (get_global $INITIAL_STACK_TOP)) (;12;)
  (global $DYNAMICTOP_PTR (mut i32) (get_global $IMPORTED_DYNAMICTOP_PTR)) (;9;)
    ;; USE BY FREE
