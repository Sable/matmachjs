...
export class MachRuntime implements IMachRuntime{
    ...
    public ndarray(data:ArrayValue, shape:number[], order="C", mclass=ValueType.float64){
        if(mclass !== ValueType.float64 || !(data instanceof Float64Array) ) 
    ...
    public ones(args?:number[],mclass=ValueType.float64): MachArray{
    ...
    public zeros(args?:number[],mclass=ValueType.float64): MachArray{
        if(mclass !== ValueType.float64)
            throw new ValueTypeError(mclass, ValueType.float64);
        let shape = this.helperShapeConstructors(args);
    ...
    public fill(value:number, args:number[]|undefined, mclass=ValueType.float64): MachArray{
        if(mclass !== ValueType.float64)
            throw new ValueTypeError(mclass, ValueType.float64);
        let shape = this.helperShapeConstructors(args);
    ...
    public randi(max_int:number, shape?:number[],mclass=ValueType.float64): MachArray{
        if(mclass !== ValueType.float64)
            throw new ValueTypeError(mclass, ValueType.float64);
    ...
    public rand(args?:number[],mclass=ValueType.float64): MachArray{
        if(mclass !== ValueType.float64)
            throw new ValueTypeError(mclass, ValueType.float64);
        let shape = this.helperShapeConstructors(args);
    ...
    public randn(args?:number[],mclass=ValueType.float64): MachArray{
        if(mclass !== ValueType.float64)
            throw new ValueTypeError(mclass, ValueType.float64);
        let shape = this.helperShapeConstructors(args);
    ...
    public eye(args?:number[],mclass=ValueType.float64): MachArray{
        if(mclass !== ValueType.float64)
            throw new ValueTypeError(mclass, ValueType.float64);
        let shape = this.helperShapeConstructors(args);
    ...
    public add(arr1: MachArray|number, arr2: MachArray|number){
        if(typeof arr1 == "number" && typeof arr2 == "number"){
            ...
            arr2 = <MachArray> arr2;
            return new MachArray(this._wi, this._wi.plus_SM(arr1, arr2._offset));
        }else if(typeof arr2 == "number" && arr1 instanceof MachArray){
            arr1 = <MachArray> arr1;
            return new MachArray(this._wi, this._wi.plus_MS(arr1._offset, arr2));
        }else {
            arr2 = <MachArray> arr2;
            arr1 = <MachArray> arr1;
            return new MachArray(this._wi, this._wi.plus_MM(arr1._offset, arr2._offset)); 
        }
    }
    ...
    public sub(arr1: MachArray|number, arr2: MachArray|number){
        if(typeof arr1 == "number" && typeof arr2 == "number"){
            ...
            arr2 = <MachArray> arr2;
            return new MachArray(this._wi, this._wi.minus_SM(arr1, arr2._offset));
        }else if(typeof arr2 == "number" && arr1 instanceof MachArray){
            arr1 = <MachArray> arr1;
            return new MachArray(this._wi, this._wi.minus_MS(arr1._offset, arr2));
        }else {
            arr2 = <MachArray> arr2;
            arr1 = <MachArray> arr1;
            return new MachArray(this._wi, this._wi.minus_MM(arr1._offset, arr2._offset)); 
        }
    }
    ...
    public mult(arr1: MachArray|number, arr2: MachArray|number){
        if(typeof arr1 == "number" && typeof arr2 == "number"){
            ...
            arr2 = <MachArray> arr2;
            return new MachArray(this._wi, this._wi.times_SM(arr1, arr2._offset));
        }else if(typeof arr2 == "number" && arr1 instanceof MachArray){
            arr1 = <MachArray> arr1;
            return new MachArray(this._wi, this._wi.times_MS(arr1._offset, arr2));
        }else {
            arr2 = <MachArray> arr2;
            arr1 = <MachArray> arr1;
            return new MachArray(this._wi, this._wi.times_MM(arr1._offset, arr2._offset)); 
        }
    }
    ...
    public mmult(arr1: MachArray|number, arr2: MachArray|number){
        if(typeof arr1 == "number" && typeof arr2 == "number"){
            ...
            arr2 = <MachArray> arr2;
            return new MachArray(this._wi, this._wi.mtimes_SM(arr1, arr2._offset));
        }else if(typeof arr2 == "number" && arr1 instanceof MachArray){
            arr1 = <MachArray> arr1;
            return new MachArray(this._wi, this._wi.mtimes_MS(arr1._offset, arr2));
        }else {
            arr2 = <MachArray> arr2;
            arr1 = <MachArray> arr1;
            return new MachArray(this._wi, this._wi.mtimes_MM(arr1._offset, arr2._offset)); 
        }
    }
    public ldivide(arr1: MachArray|number, arr2: MachArray|number){
        if(typeof arr1 == "number" && typeof arr2 == "number"){
            ...
            arr2 = <MachArray> arr2;
            return new MachArray(this._wi, this._wi.ldivide_SM(arr1, arr2._offset));
        }else if(typeof arr2 == "number" && arr1 instanceof MachArray){
            arr1 = <MachArray> arr1;
            return new MachArray(this._wi, this._wi.ldivide_MS(arr1._offset, arr2));
        }else {
            arr2 = <MachArray> arr2;
            arr1 = <MachArray> arr1;
            return new MachArray(this._wi, this._wi.ldivide_MM(arr1._offset, arr2._offset)); 
        }
    }
    public rdivide(arr1: MachArray|number, arr2: MachArray|number){
        if(typeof arr1 == "number" && typeof arr2 == "number"){
            ...
            arr2 = <MachArray> arr2;
            return new MachArray(this._wi, this._wi.rdivide_SM(arr1, arr2._offset));
        }else if(typeof arr2 == "number" && arr1 instanceof MachArray){
            arr1 = <MachArray> arr1;
            return new MachArray(this._wi, this._wi.rdivide_MS(arr1._offset, arr2));
        }else {
            arr2 = <MachArray> arr2;
            arr1 = <MachArray> arr1;
            return new MachArray(this._wi, this._wi.rdivide_MM(arr1._offset, arr2._offset)); 
        }
    }
    public rem(arr1: MachArray|number, arr2: MachArray|number){
        if(typeof arr1 == "number" && typeof arr2 == "number"){
            ...
            arr2 = <MachArray> arr2;
            return new MachArray(this._wi, this._wi.rem_SM(arr1, arr2._offset));
        }else if(typeof arr2 == "number" && arr1 instanceof MachArray){
            arr1 = <MachArray> arr1;
            return new MachArray(this._wi, this._wi.rem_MS(arr1._offset, arr2));
        }else {
            arr2 = <MachArray> arr2;
            arr1 = <MachArray> arr1;
            return new MachArray(this._wi, this._wi.rem_MM(arr1._offset, arr2._offset)); 
        }
    }
    public mod(arr1: MachArray|number, arr2: MachArray|number){
        if(typeof arr1 == "number" && typeof arr2 == "number"){
            ...
            arr2 = <MachArray> arr2;
            return new MachArray(this._wi, this._wi.mod_SM(arr1, arr2._offset));
        }else if(typeof arr2 == "number" && arr1 instanceof MachArray){
            arr1 = <MachArray> arr1;
            return new MachArray(this._wi, this._wi.mod_MS(arr1._offset, arr2));
        }else {
            arr2 = <MachArray> arr2;
            arr1 = <MachArray> arr1;
            return new MachArray(this._wi, this._wi.mod_MM(arr1._offset, arr2._offset)); 
        }
    }
    public power(arr1: MachArray|number, arr2: MachArray|number){
        if(typeof arr1 == "number" && typeof arr2 == "number"){
            ...
            arr2 = <MachArray> arr2;
            return new MachArray(this._wi, this._wi.power_SM(arr1, arr2._offset));
        }else if(typeof arr2 == "number" && arr1 instanceof MachArray){
            arr1 = <MachArray> arr1;
            return new MachArray(this._wi, this._wi.power_MS(arr1._offset, arr2));
        }else {
            arr2 = <MachArray> arr2;
            arr1 = <MachArray> arr1;
            return new MachArray(this._wi, this._wi.power_MM(arr1._offset, arr2._offset)); 
        }
    }
    public lt(arr1: MachArray|number, arr2: MachArray|number){
        if(typeof arr1 == "number" && typeof arr2 == "number"){
            ...
            arr2 = <MachArray> arr2;
            return new MachArray(this._wi, this._wi.lt_SM(arr1, arr2._offset));
        }else if(typeof arr2 == "number" && arr1 instanceof MachArray){
            arr1 = <MachArray> arr1;
            return new MachArray(this._wi, this._wi.lt_MS(arr1._offset, arr2));
        }else {
            arr2 = <MachArray> arr2;
            arr1 = <MachArray> arr1;
            return new MachArray(this._wi, this._wi.lt_MM(arr1._offset, arr2._offset)); 
        }
    }    
    public le(arr1: MachArray|number, arr2: MachArray|number){
        if(typeof arr1 == "number" && typeof arr2 == "number"){
            ...
            arr2 = <MachArray> arr2;
            return new MachArray(this._wi, this._wi.le_SM(arr1, arr2._offset));
        }else if(typeof arr2 == "number" && arr1 instanceof MachArray){
            arr1 = <MachArray> arr1;
            return new MachArray(this._wi, this._wi.le_MS(arr1._offset, arr2));
        }else {
            arr2 = <MachArray> arr2;
            arr1 = <MachArray> arr1;
            return new MachArray(this._wi, this._wi.le_MM(arr1._offset, arr2._offset)); 
        }
    }   
    public gt(arr1: MachArray|number, arr2: MachArray|number){
        if(typeof arr1 == "number" && typeof arr2 == "number"){
            ...
            arr2 = <MachArray> arr2;
            return new MachArray(this._wi, this._wi.gt_SM(arr1, arr2._offset));
        }else if(typeof arr2 == "number" && arr1 instanceof MachArray){
            arr1 = <MachArray> arr1;
            return new MachArray(this._wi, this._wi.gt_MS(arr1._offset, arr2));
        }else {
            arr2 = <MachArray> arr2;
            arr1 = <MachArray> arr1;
            return new MachArray(this._wi, this._wi.gt_MM(arr1._offset, arr2._offset)); 
        }
    } 
    public ge(arr1: MachArray|number, arr2: MachArray|number){
        if(typeof arr1 == "number" && typeof arr2 == "number"){
            ...
            arr2 = <MachArray> arr2;
            return new MachArray(this._wi, this._wi.ge_SM(arr1, arr2._offset));
        }else if(typeof arr2 == "number" && arr1 instanceof MachArray){
            arr1 = <MachArray> arr1;
            return new MachArray(this._wi, this._wi.ge_MS(arr1._offset, arr2));
        }else {
            arr2 = <MachArray> arr2;
            arr1 = <MachArray> arr1;
            return new MachArray(this._wi, this._wi.ge_MM(arr1._offset, arr2._offset)); 
        }
    } 
    ...
    public eq(arr1: MachArray|number, arr2: MachArray|number){
        if(typeof arr1 == "number" && typeof arr2 == "number"){
            ...
            arr2 = <MachArray> arr2;
            return new MachArray(this._wi, this._wi.eq_SM(arr1, arr2._offset));
        }else if(typeof arr2 == "number" && arr1 instanceof MachArray){
            arr1 = <MachArray> arr1;
            return new MachArray(this._wi, this._wi.eq_MS(arr1._offset, arr2));
        }else {
            arr2 = <MachArray> arr2;
            arr1 = <MachArray> arr1;
            return new MachArray(this._wi, this._wi.eq_MM(arr1._offset, arr2._offset)); 
        }
    } 
    ...
    public ne(arr1: MachArray|number, arr2: MachArray|number){
        if(typeof arr1 == "number" && typeof arr2 == "number"){
            ...
            arr2 = <MachArray> arr2;
            return new MachArray(this._wi, this._wi.ne_SM(arr1, arr2._offset));
        }else if(typeof arr2 == "number" && arr1 instanceof MachArray){
            arr1 = <MachArray> arr1;
            return new MachArray(this._wi, this._wi.ne_MS(arr1._offset, arr2));
        }else {
            arr2 = <MachArray> arr2;
            arr1 = <MachArray> arr1;
            return new MachArray(this._wi, this._wi.ne_MM(arr1._offset, arr2._offset)); 
        }
    } 
    public all(arr1: MachArray|number, dim:number):MachArray|boolean{
        if(typeof arr1 === "number") return arr1 != 0;
        let res = new MachArray(this._wi, this._wi.all(arr1._offset,dim+1));
        if(res._numel === 1) return res._data[0] != 0;
        else return res;
    } 

    public any(arr1: MachArray|number, dim:number):MachArray|boolean{
        if(typeof arr1 === "number") return arr1 != 0;
        let res = new MachArray(this._wi, this._wi.any(arr1._offset,dim+1));
        if(res._numel === 1) return res._data[0] != 0;
        else return res;
    }
    public mean(arr1:MachArray|number, dim:number,naNFlag=false){
        if(typeof arr1 === "number") return arr1;
        else return new MachArray(this._wi, this._wi.mean(arr1._offset, dim, naNFlag));
    } 
    public floor(arr1: MachArray|number){
        if(typeof arr1 === "number") return Math.floor(arr1);
        else return new MachArray(this._wi, this._wi.floor_M(arr1._offset)); 
    }
    public ceil(arr1: MachArray|number){
        if(typeof arr1 === "number") return Math.ceil(arr1);
        else return new MachArray(this._wi, this._wi.ceil_M(arr1._offset)); 
    }
    public sin(arr1: MachArray|number){
        if(typeof arr1 === "number") return Math.sin(arr1);
        else return new MachArray(this._wi, this._wi.sin_M(arr1._offset)); 
    }
    public cos(arr1: MachArray|number){
        if(typeof arr1 === "number") return Math.cos(arr1);
        else return new MachArray(this._wi, this._wi.cos_M(arr1._offset)); 
    }
    public tan(arr1: MachArray|number){
        if(typeof arr1 === "number") return Math.tan(arr1);
        else return new MachArray(this._wi, this._wi.tan_M(arr1._offset)); 
    }
    public sqrt(arr1: MachArray|number){
        if(typeof arr1 === "number") return Math.sqrt(arr1);
        else return new MachArray(this._wi, this._wi.sqrt_M(arr1._offset)); 
    }
    public uminus(arr1: MachArray|number){
        if(typeof arr1 === "number") return -arr1;
        else return new MachArray(this._wi, this._wi.uminus_M(arr1._offset)); 
    }
    public round(arr1: MachArray|number){
        if(typeof arr1 === "number") return Math.round(arr1);
        else return new MachArray(this._wi, this._wi.round_M(arr1._offset)); 
    }
    public exp(arr1: MachArray|number){
        if(typeof arr1 === "number") return Math.exp(arr1);
        else return new MachArray(this._wi, this._wi.exp_M(arr1._offset)); 
    }
    public log(arr1: MachArray|number){
        if(typeof arr1 === "number") return Math.log(arr1);
        else return new MachArray(this._wi, this._wi.log_M(arr1._offset)); 
    }
    ...
    public not(arr1: MachArray|number){
        ...
        else return new MachArray(this._wi, this._wi.not_M(arr1._offset)); 
    }
    public fix(arr1: MachArray|number){
        if(typeof arr1 === "number") return this._wi.fix_S(arr1);
        else return new MachArray(this._wi, this._wi.fix_M(arr1._offset)); 
    }
    public sum(arr1:MachArray|number, dim:number=0, nanFlag=false){
        if(typeof arr1 === "number") return arr1; 
        return new MachArray(this._wi, this._wi.sum_M(arr1._offset,dim, nanFlag));

    }
    public prod(arr1:MachArray|number, dim:number=0, nanFlag=false){
        if(typeof arr1 === "number") return arr1; 
        return new MachArray(this._wi, this._wi.prod_M(arr1._offset,dim, nanFlag));
    }
    public transpose(arr1:MachArray|number){
        if(typeof arr1 === "number") return arr1; 
        return new MachArray(this._wi, this._wi.transpose_M(arr1._offset));
    }
    public concat(arrays:MachArray[], dim?:number){
        ...
        if(arrays.length > 0){
            ...
            let res =  new MachArray(this._wi, this._wi.concat(dim, inp_vec._offset));
            inp_vec.free();
            return res;
        }else{
    ...
    public horzcat(arrays: Array<MachArray>){
        if(arrays.length > 1){
            ...
            let res =  new MachArray(this._wi, this._wi.horzcat(inp_vec._offset));
            inp_vec.free();
            return res;
        }else{
    ...
    public vertcat(arrays:MachArray[]){
        if(arrays.length > 1){
            ...
            return new MachArray(this._wi, this._wi.vertcat(inp_vec._offset));
        }else{
